...
// Mouse input
MAPI b8 input_is_button_down(buttons button);
MAPI b8 input_is_button_up(buttons button);
MAPI b8 input_was_button_down(buttons button);
MAPI b8 input_was_button_up(buttons button);
