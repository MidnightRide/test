    ...
    vulkan_framebuffer *out_framebuffer)
{
    ...
    out_framebuffer->attachments = mallocate(sizeof(VkImageView) * attachment_count, MEMORY_TAG_RENDERER);
...
void vulkan_framebuffer_destroy(vulkan_context *context, vulkan_framebuffer *framebuffer)
{
    ...
    {
        mfree(framebuffer->attachments, sizeof(VkImageView) * framebuffer->attachment_count, MEMORY_TAG_RENDERER);
