...
MAPI void memory_system_initialise(u64 *memory_requirements, void *state);
MAPI void memory_system_shutdown(void *state);
...
MAPI char *get_memory_use_str();

MAPI u64 get_memory_alloc_count();