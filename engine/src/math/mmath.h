...
MAPI i32 mrandom();
MAPI i32 mrandom_in_range(i32 min, i32 max);

MAPI f32 fmrandom();
MAPI f32 fmrandom_in_range(f32 min, f32 max);
 ...
 */
MINLINE vec2 vec2_add(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
 ...
 * @return The resulting vector. 
 */
MINLINE vec2 vec2_sub(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
 ...
 * @return The resulting vector. 
 */
MINLINE vec2 vec2_mul(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y};
 ...
 * @return The resulting vector. 
 */
MINLINE vec2 vec2_div(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y};
 ...
 */
MINLINE f32 vec2_length_squared(vec2 vector)
{
 ...
 * @return The length.
 */
MINLINE f32 vec2_length(vec2 vector)
{
    return msqrt(vec2_length_squared(vector));
}
 ...
 */
MINLINE void vec2_normalize(vec2 *vector)
{
 ...
 */
MINLINE vec2 vec2_normalized(vec2 vector)
{
 ...
 * @param vector_0 The first vector.
 * @param vector_1 The second vector.
 * @param tolerance The difference tolerance. Typically M_FLOAT_EPSILON or similar.
 * @return True if within tolerance; otherwise false. 
 */
MINLINE b8 vec2_compare(vec2 vector_0, vec2 vector_1, f32 tolerance)
{
    if (mabs(vector_0.x - vector_1.x) > tolerance)
    {
        return false;
    }
    
    if (mabs(vector_0.y - vector_1.y) > tolerance)
    {
        return false;
    }
 ...
 */
MINLINE f32 vec2_distance(vec2 vector_0, vec2 vector_1)
{
    vec2 d = (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
 ...
 * @return A new vec3 
 */
MINLINE vec3 vec3_from_vec4(vec4 vector)
{
 ...
 * @return A new vec4 
 */
MINLINE vec4 vec3_to_vec4(vec3 vector, f32 w)
{
 ...
 * @return The resulting vector. 
 */
MINLINE vec3 vec3_add(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x + vector_1.x,
        vector_0.y + vector_1.y,
 ...
 * @return The resulting vector. 
 */
MINLINE vec3 vec3_sub(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
 ...
 * @return The resulting vector. 
 */
MINLINE vec3 vec3_mul(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y,
 ...
 */
MINLINE vec3 vec3_mul_scalar(vec3 vector_0, f32 scalar)
{
    return (vec3){
        vector_0.x * scalar,
        vector_0.y * scalar,
 ...
 * @return The resulting vector. 
 */
MINLINE vec3 vec3_div(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y,
 ...
 * @return The squared length.
 */
MINLINE f32 vec3_length_squared(vec3 vector)
{
 ...
 * @return The length.
 */
MINLINE f32 vec3_length(vec3 vector)
{
    return msqrt(vec3_length_squared(vector));
}
 ...
 * @param vector A pointer to the vector to be normalized.
 */
MINLINE void vec3_normalize(vec3 *vector)
{
 ...
 * @return A normalized copy of the supplied vector 
 */
MINLINE vec3 vec3_normalized(vec3 vector)
{
 ...
 */
MINLINE f32 vec3_dot(vec3 vector_0, vec3 vector_1)
{
    f32 p = 0;
 ...
 */
MINLINE vec3 vec3_cross(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
 ...
 * @return True if within tolerance; otherwise false. 
 */
MINLINE const b8 vec3_compare(vec3 vector_0, vec3 vector_1, f32 tolerance)
{
    if (mabs(vector_0.x - vector_1.x) > tolerance)
    {
        return false;
    ...
    if (mabs(vector_0.z - vector_1.z) > tolerance)
    {
        return false;
    }
 ...
 * @return The distance between vector_0 and vector_1.
 */
MINLINE f32 vec3_distance(vec3 vector_0, vec3 vector_1)
{
    vec3 d = (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
 ...
 * @return A new vec3 
 */
MINLINE vec3 vec4_to_vec3(vec4 vector)
{
    return (vec3){vector.x, vector.y, vector.z};
}
 ...
 * @return A new vec4 
 */
MINLINE vec4 vec4_from_vec3(vec3 vector, f32 w)
{
#if defined(KUSE_SIMD)
    vec4 out_vector;
    out_vector.data = _mm_setr_ps(x, y, z, w);
 ...
 * @return The resulting vector. 
 */
MINLINE vec4 vec4_add(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; ++i)
    {
 ...
 * @return The resulting vector. 
 */
MINLINE vec4 vec4_sub(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; ++i)
    {
 ...
 * @return The resulting vector. 
 */
MINLINE vec4 vec4_mul(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; ++i)
    {
 ...
 * @return The resulting vector. 
 */
MINLINE vec4 vec4_div(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; ++i)
    {
 ...
 * @return The squared length.
 */
MINLINE f32 vec4_length_squared(vec4 vector)
{
 ...
 * @return The length.
 */
MINLINE f32 vec4_length(vec4 vector)
{
    return msqrt(vec4_length_squared(vector));
}
 ...
 * @param vector A pointer to the vector to be normalized.
 */
MINLINE void vec4_normalize(vec4 *vector)
{
 ...
 * @return A normalized copy of the supplied vector 
 */
MINLINE vec4 vec4_normalized(vec4 vector)
{
...
{
    mat4 out_matrix;
    mzero_memory(out_matrix.data, sizeof(f32) * 16);
 ...
 */
MINLINE mat4 mat4_mul(mat4 matrix_0, mat4 matrix_1)
{
...
/**
 * @brief Creates and returns an orthographic projection matrix. Typically used to render 
 * flat or 2D scenes.
 * 
 * @param left The left side of the view fustrum.
 * @param right The right side of the view fustrum.
 * @param bottom The bottom side of the view fustrum.
 * @param top The top side of the view fustrum.
 ...
 */
MINLINE mat4 mat4_orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near_clip, f32 far_clip)
{
    mat4 out_matrix = mat4_identity();
 ...
 */
MINLINE mat4 mat4_look_at(vec3 position, vec3 target, vec3 up)
{
    mat4 out_matrix;
    vec3 z_axis;
...
MINLINE mat4 mat4_euler_y(f32 angle_radians) {
    mat4 out_matrix = mat4_identity();
    f32 c = mcos(angle_radians);
    f32 s = msin(angle_radians);
...
MINLINE mat4 mat4_euler_z(f32 angle_radians) {
    mat4 out_matrix = mat4_identity();
...
MINLINE mat4 mat4_euler_xyz(f32 x_radians, f32 y_radians, f32 z_radians) {
 ...
 */
MINLINE vec3 mat4_forward(mat4 matrix) {
    vec3 forward;
 ...
 * @return A 3-component directional vector.
 */
MINLINE vec3 mat4_backward(mat4 matrix) {
    vec3 backward;
 ...
 * @return A 3-component directional vector.
 */
MINLINE vec3 mat4_up(mat4 matrix) {
    vec3 up;
    up.x = matrix.data[1];
    up.y = matrix.data[5];
    up.z = matrix.data[9];
 ...
 * @return A 3-component directional vector.
 */
MINLINE vec3 mat4_down(mat4 matrix) {
    vec3 down;
 ...
 * @return A 3-component directional vector.
 */
MINLINE vec3 mat4_left(mat4 matrix) {
    vec3 left;
 ...
 * @return A 3-component directional vector.
 */
MINLINE vec3 mat4_right(mat4 matrix) {
    vec3 right;
...
MINLINE quat quat_from_axis_angle(vec3 axis, f32 angle, b8 normalize) {
    const f32 half_angle = 0.5f * angle;
    f32 s = msin(half_angle);
    f32 c = mcos(half_angle);
 ...
 */
MINLINE f32 deg_to_rad(f32 degrees) {
 ...
 */
MINLINE f32 rad_to_deg(f32 radians) {
