                              ...
                              u32 stencil)
{
    ...
    // Attachments TODO(satvik): make this configurable.
    const u32 attachment_description_count = 2;
    VkAttachmentDescription attachment_descriptions[attachment_description_count];
    
    // Color attachment
    VkAttachmentDescription color_attachment;
    color_attachment.format = context->swapchain.image_format.format; // TODO(satvik): configurable
    ...
    // TODO(satvik): other attachment types (input, resolve, preserve)
    ...
    // Render pass dependencies. TODO(satvik): make this configurable.
                             ...
                             VkFramebuffer frame_buffer)
{
    ...
    mzero_memory(clear_values, sizeof(VkClearValue) * 2);
